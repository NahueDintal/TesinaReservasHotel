...
=======
    ...
    @FXML
    private ComboBox<Customer> cmbCustomer;
>>>>>>> 83c5f99 (Actualiza reservas y nueva reserva)
  ...
  private final List<Consumption> consumptionsModificados = new java.util.ArrayList<>();
...
>>>>>>> 83c5f99 (Actualiza reservas y nueva reserva)
  ...
  public void setReservationToEdit(
    ...
    try {
      ...
      Customer customer = customerDAO.searchById(
...
>>>>>>> 83c5f99 (Actualiza reservas y nueva reserva)
  ...
  private void cargarPagoDeReserva(
    ...
    try {
      ...
      List<Payment> payments = paymentRepo.getPaymentsByReservation(
          idReservation);
...
>>>>>>> 83c5f99 (Actualiza reservas y nueva reserva)
  ...
  private void cargarConsumosDeReserva(
    ...
    try {
      ...
      List<Consumption> consumptionsBD = consumptionRepo.getConsumptionsByReservation(
          idReservation);
  ...
  public void initialize() {
    ...
    cmbConsumptionType.setOnAction(event -> {
      ...
      Integer tipo = cmbConsumptionType.getValue();
  ...
  private void loadReservationStatuses() {
    ...
    try {
      ...
      List<ReservationStatus> statuses = reservationStatusRepo
          .getReservationStatuses();
  ...
  private void loadReservationTypes() {
    ...
    try {
      ...
      List<ReservationType> types = reservationTypeRepo
          .getReservationTypes();
  ...
  private void loadPaymentMethods() {
    ...
    try {
      ...
      List<PaymentMethod> methods = paymentMethodRepo
          .getPaymentMethods();
  ...
  private void loadPaymentStatuses() {
    ...
    try {
      ...
      List<PaymentStatus> statuses = paymentStatusRepo
          .getPaymentStatuses();
  ...
  private void handleAddConsumption() {
    ...
    Integer consumptionType = cmbConsumptionType.getValue();
    ...
    String textoQuantity = txtConsumptionQuantity
        .getText()
        .trim();
  ...
  private void handleModifyConsumption() {
    ...
    if (consumoEnEdicion != null) {
      ...
      String textoQuantity = txtConsumptionQuantity.getText().trim();
      ...
      try {
        ...
        quantity = Integer.parseInt(textoQuantity);
    ...
    Consumption selected = tblConsumptions.getSelectionModel()
        .getSelectedItem();
    ...
    if (selected.getIdConsumptionType() == 1) {
      ...
      Product product = cmbProduct.getItems()
          .stream()
      ...
      Service service = cmbService.getItems()
          .stream()
  ...
  private void handleSave() {
    ...
    try {
      ...
      String textoGuests = txtNumberOfGuests
          .getText()
          .trim();
      ...
      String reservationObservations = txtReservationObservations
          .getText();
      ...
      if (reservationToEdit == null) {
        ...
        idReservation = reservationRepo.createReservation(
            conn,
            reservation);
        ...
        boolean updated = reservationRepo.updateReservation(
            conn,
            reservation);
        ...
        idReservation = reservationToEdit
            .getIdReservation();
      }
      ...
      for (Consumption consumption : consumptions) {
        ...
        if (consumption.getIdConsumption() == 0) {
          ...
          boolean consumptionCreated = consumptionRepo.createConsumption(
              conn,
              consumption);
      ...
      for (Consumption consumption : consumptionsModificados) {

        boolean consumptionUpdated = consumptionRepo.updateConsumption(
            conn,
            consumption);
      ...
      String textoPayment = txtPaymentAmount
          .getText()
          .trim();
      ...
      if (!textoPayment.isEmpty()) {
        ...
        LocalDateTime paymentDate = dpPaymentDate
            .getValue()
            .atStartOfDay();

        String paymentObservations = txtPaymentObservations
            .getText();
        ...
        if (reservationToEdit != null) {
          ...
          if (!payments.isEmpty()) {
            ...
            boolean paymentUpdated = paymentRepo.updatePayment(
                conn,
                payment);
            ...
            boolean paymentCreated = paymentRepo.createPayment(
                conn,
                payment);
