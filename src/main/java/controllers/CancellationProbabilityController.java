...
public class CancellationProbabilityController {
  ...
  private void updateKpis() {
    ...
    double p = total == 0 ? 0 : (double) cancelled / total;

    totalReservationsLabel.setText(String.valueOf(total));
    cancelledReservationsLabel.setText(String.valueOf(cancelled));
    globalProbabilityLabel.setText(String.format("%.2f %%", p * 100));
    globalProbabilityBar.setProgress(p);
  }
