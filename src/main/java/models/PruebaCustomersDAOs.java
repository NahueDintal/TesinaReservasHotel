...
public class PruebaCustomersDAOs {
    public static void main(String[] args) {
        try {
            ...
            Map<Integer, String> tipos = docDAO.listarTodos();
            ...
            Map<Integer, String> paises = paisDAO.listarTodos();
            System.out.println("\n=== PAÍSES ===");
            ...
            Map<Integer, String> estados = statusDAO.listarTodos();
            System.out.println("\n=== ESTADOS ===");
            ...
            Map<Integer, String> origenes = origenDAO.listarTodos();
            System.out.println("\n=== ORÍGENES ===");
